...
with open('Input Code Files\Examples\example.txt', 'r') as file:
...
with open('Input Code Files\Examples\example.txt', 'r', encoding='utf-8') as file:
    lines = file.readlines() 
...
with open('Input Code Files\Examples\example.txt', 'r', encoding='utf-8-sig') as file:
    lines = file.readlines() 
print(lines)
